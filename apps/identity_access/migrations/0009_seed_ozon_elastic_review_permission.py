...
NEW_PERMISSION = {
    "ozon.api.elastic.review": (
        "Ozon API: принять/не принять результат",
        "store",
    ),
}
...
def seed_ozon_elastic_review_permission(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ("identity_access", "0008_seed_ozon_elastic_calculation_permission"),
    ]

    operations = [
        migrations.RunPython(
            seed_ozon_elastic_review_permission,
