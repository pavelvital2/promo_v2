...
На 2026-05-02 CORE-2 documentation package passed audit and recheck. После AUDIT PASS заказчик дал решения по `GAP-CORE2-001`..`GAP-CORE2-005`; customer-decision blockers сняты. Entries remain here as resolved decision records with implementation constraints. Product code, migrations and tests are still not implemented by these documentation updates.
