...
- Закрытые решения по `GAP-0002`, `GAP-0003`, `GAP-0004`, `GAP-0007`, `GAP-0008`, `GAP-0009` не изменяются предположениями; для `GAP-0008` остаётся artifact gate по фактическим контрольным файлам.
