...
- На 2026-05-02 Stage 3.0 CORE-1 Product Core release validation accepted as PASS WITH NOTES in `docs/reports/CORE_1_RELEASE_VALIDATION_REPORT.md`; CORE-2 design documentation has audit/recheck PASS, post-audit customer decisions for `GAP-CORE2-001`..`GAP-CORE2-006` are recorded, and `GAP-CORE2-007` is deferred/future for the mapping-table workflow. CORE-2 implementation still requires follow-up audit/recheck of the updated docs and a separate task-scoped implementation assignment.
